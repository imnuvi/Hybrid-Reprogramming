...
def save_frame_to_hdf5(frame, scene, count, timepoint):
    """
    ...
    bpath = f"/scratch/indikar_root/indikar1/shared_data/ImageProcessing/{scene}/{count}"
    ...
    for t in range(timepoints):
        ...
        for c in range(channels):
            ...
            for i in range(rows * columns):
                img, shp = czi.read_image(C=c, S=scene, Z=0, T=t, M=i)
